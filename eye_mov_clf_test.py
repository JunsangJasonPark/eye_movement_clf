...
# recommend to use pass_sav_gol function
...
def pass_sav_gol_filter(coordinate_data, window, polyorder):
    coordinate_data['X'] = savgol_filter(coordinate_data['X'], window, polyorder)
    coordinate_data['Y'] = savgol_filter(coordinate_data['Y'], window, polyorder)
